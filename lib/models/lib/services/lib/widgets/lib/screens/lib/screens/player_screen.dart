  ...
  void _blockAds() {
    _webCtrl.runJavaScript('''
      (function() {
        ...
        style.innerHTML = `
          .overlay,.popup,[class*="popup"],[class*="overlay"],
          [id*="popup"],[id*="overlay"],.ads,[class*="ads"],
          [id*="ads"],.banner,[class*="banner"],
        ...
        setInterval(function(){
          document.querySelectorAll('div,iframe').forEach(function(el){
            ...
            if(z>9000&&!el.querySelector('video')){el.style.display='none';}
          });
        },1000);
      })();
    ''');
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    _buildInfo(),
                    if (widget.movie.type == 'series') _buildEpisodes(),
            ...
            children: [
              Expanded(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('ভিডিওতে Long Press করে Download করুন')),
                  ),
                ),
              ),
              ...
              Expanded(
                ...
                child: OutlinedButton.icon(
                  ...
                  onPressed: () =>
                    Share.share('Watch ${widget.movie.title} on Movie App!'),
                ),
              ),
            ],
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: List.generate(_totalEpisodes, (i) {
              final e = i + 1;
              final on = _curEpisode == e;
              return GestureDetector(
                onTap: () => setState(() => _curEpisode = e),
                child: Container(
                  width: 40, height: 40,
                  decoration: BoxDecoration(
                    color: on ? const Color(0xFFe50914) : const Color(0xFF2a2a2a),
